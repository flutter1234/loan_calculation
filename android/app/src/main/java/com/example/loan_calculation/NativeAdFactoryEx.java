package com.example.loan_calculation;
...
import com.example.loan_calculation.R;
...
class NativeAdFactoryEx implements NativeAdFactory {
    private final LayoutInflater layoutInflater;

    NativeAdFactoryEx(LayoutInflater layoutInflater) {
